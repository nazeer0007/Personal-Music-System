@echo off
echo ========================================================
echo        STARTING TUNEFLOW 🎵 JAVAFX DESKTOP GUI
echo ========================================================
...
echo [INFO] Launching JavaFX Desktop Application...
java --module-path "javafx-sdk-23.0.1\lib" --add-modules javafx.controls,javafx.media,javafx.fxml -cp "lib\*;bin" TuneFlowApp
